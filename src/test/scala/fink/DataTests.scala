...
class DataTests extends FunSuite with BeforeAndAfterAll with RepositorySupport {
	...
	// 	println("should save and findall")
	...
	// 	println("should save in transaction and findall")
	// 	val count = 10
	...
	// 	println("should handle categories")
	...
	test("should save post-category relations") {
		println("should save post-category relations")
